...
class Config:
    ...
    # --- Experiment ---
    EXP_NAME: str = "exp101_02_segformer"
    SEED: int = 42
    N_FOLDS: int = 5
    ...
    IN_CHANNELS: int = 3  # RGB-only (Different contract from ConvNeXt)
    ...
    # --- Loss (FIXED) ---
    USE_DEPTH_AUX: bool = False # RGB-only: No depth aux
    ...
    def validate(self) -> None:
        ...
        if int(self.IN_CHANNELS) != 3:
            errors.append(f"IN_CHANNELS must be 3 (got {self.IN_CHANNELS})")

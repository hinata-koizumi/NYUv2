...
# --- Configuration ---
class Config:
    EXP_NAME = "exp091_fpn_effb4_hr_smartcrop"
    SEED = 42
...
class MultiTaskFPN(nn.Module):
    def __init__(self, num_classes, in_channels):
        ...
        # Typically 256, but for some encoders (like effnet-b4) it might be 128 in smp implementation.
        # We read it dynamically if available, else default to 256 or segmentation_head input.
        try:

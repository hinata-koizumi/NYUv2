...
# Dynamic import for numbered package
nearest_pkg = importlib.import_module("01_nearest")
base_config = importlib.import_module("01_nearest.configs.base_config")
Config = base_config.Config

fold_utils = importlib.import_module("01_nearest.data.fold_utils")
get_split_files = fold_utils.get_split_files

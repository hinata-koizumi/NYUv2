...
class NYUv2(VisionDataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.include_depth:
            depth_np = self._load_depth(self.depths[idx])
        ...
        if self.include_depth and geo is None and depth_tensor is None and depth_img is not None:
